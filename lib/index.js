...
var _ReactDraggableResizable = __webpack_require__(6);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_ReactDraggableResizable).default;
  }
});
...
var async = function async(func) {
    return setTimeout(func);
};

var ReactDraggableResizable = function (_React$Component) {
    _inherits(ReactDraggableResizable, _React$Component);

    function ReactDraggableResizable(props) {
        _classCallCheck(this, ReactDraggableResizable);

        var _this = _possibleConstructorReturn(this, (ReactDraggableResizable.__proto__ || Object.getPrototypeOf(ReactDraggableResizable)).call(this, props));
        ...
        _this.parentX = _this.parentY = 0;
        _this.parentW = _this.parentH = 9999;
        _this.mouseX = _this.mouseY = 0;
        _this.lastMouseX = _this.lastMouseY = 0;
        _this.mouseOffX = _this.mouseOffY = 0;
        _this.elmX = _this.elmY = 0;
        _this.elmW = _this.elmH = 0;
        return _this;
    }

    _createClass(ReactDraggableResizable, [{
        ...
        value: function elmDown(event) {
            ...
            if (this.$el.contains(target)) {
                ...
                var _props = this.props,
                    ...
                    activeUpdated = _props.activeUpdated,
        ...
        key: 'fillParent',
        value: function fillParent(event) {
            var _this2 = this;

            var _props2 = this.props,
                axis = _props2.axis,
                resizing = _props2.resizing,
                parent = _props2.parent,
                resizable = _props2.resizable,
                maximize = _props2.maximize;
            ...
            var animate = function animate() {
                ...
                if (axis === 'x') {
                    if (width === _this2.parentW || left === _this2.parentX) {
                        done = true;
                    }
                } else if (axis === 'y') {
                    if (height === _this2.parentH || top === _this2.parentY) {
                        done = true;
                    }
                } else if (axis === 'both') {
                    if (width === _this2.parentW && height === _this2.parentH && top === _this2.parentY && left === _this2.parentX) {
                        done = true;
                    }
                }

                if (axis === 'x' || axis === 'both') {
                    if (width < _this2.parentW) {
                        _this2.elmW++;
        ...
        key: 'handleDown',
        value: function handleDown(handle, event) {
            event.stopPropagation();
        ...
        value: function handleMove(event) {
            ...
            var resizingCallback = this.props.resizing;
            var draggingCallback = this.props.dragging;
        ...
        value: function deselect(event) {
            ...
            var target = event.target || event.srcElement;
            var regexp = new RegExp('handle-([trmbl]{2})', '');

            if (!this.$el.contains(target) && !regexp.test(target.className)) {
                var _props4 = this.props,
                    deactivated = _props4.deactivated,
                    activeUpdated = _props4.activeUpdated;
        ...
        value: function handleUp(event) {
            ...
            var _state5 = this.state,
                ...
                top = _state5.top,
                left = _state5.left,
                resizing = _state5.resizing,
                dragging = _state5.dragging;
            var _props5 = this.props,
                resizestop = _props5.resizestop,
                dragstop = _props5.dragstop;
        ...
        value: function reviewDimensions() {
            var _this5 = this;
            ...
            var _props6 = this.props,
                ...
                minh = _props6.minh,
                h = _props6.h,
                parent = _props6.parent,
                x = _props6.x,
                y = _props6.y,
                resizing = _props6.resizing;
        ...
        value: function render() {
            ...
            var _props7 = this.props,
                draggable = _props7.draggable,
                resizable = _props7.resizable,
                handles = _props7.handles,
                children = _props7.children;
            var _state7 = this.state,
                dragging = _state7.dragging,
                resizing = _state7.resizing,
                width = _state7.width,
                height = _state7.height,
                top = _state7.top,
                left = _state7.left,
                zIndex = _state7.zIndex,
                enabled = _state7.enabled;

            return _react2.default.createElement(
                'div',
                {
                    className: (0, _classnames2.default)('vdr', {
                        draggable: draggable,
                        resizable: resizable,
                        active: enabled,
                        dragging: dragging,
                ...
                resizable && handles.map(function (handle) {
                    return _react2.default.createElement('div', {
                        className: (0, _classnames2.default)('handle', 'handle-' + handle),
                        key: handle,
                        style: { display: enabled ? 'block' : 'none' },
                        onMouseDown: _this6.handleDown.bind(_this6, handle)
                    });
                }),
                children
            );
    ...
    return ReactDraggableResizable;
}(_react2.default.Component);

ReactDraggableResizable.propTypes = {
    ...
    grid: _propTypes2.default.array,
    parent: _propTypes2.default.bool,
    maximize: _propTypes2.default.bool,
    resizing: _propTypes2.default.func,
    activated: _propTypes2.default.func,
    activeUpdated: _propTypes2.default.func,
    deactivated: _propTypes2.default.func,
    resizestop: _propTypes2.default.func,
    dragstop: _propTypes2.default.func,
    dragging: _propTypes2.default.func
};
ReactDraggableResizable.defaultProps = {
    active: false,
    draggable: true,
    resizable: true,
    w: 200,
...
exports.default = ReactDraggableResizable;
...
var propIsNumberAndGtSomeValue = exports.propIsNumberAndGtSomeValue = function propIsNumberAndGtSomeValue(minValue) {
...
var valueMustBeInArray = exports.valueMustBeInArray = function valueMustBeInArray(array) {
    return function (props, propName, componentName) {
...
var valueIsStringOrNumberWithDefault = exports.valueIsStringOrNumberWithDefault = function valueIsStringOrNumberWithDefault(typeArray) {
    return function (type, value) {
        return function (props, propName, componentName) {
            var valueType = _typeof(props[propName]);
